module Api
  module V1
    ...
    def create
      ...
      if @resource
        @redirect_url = APP_CONFIG['HOST_ENDPOINT']+'/reset-password'
    ...
    def edit
      ...
      if @resource && @resource.reset_password_period_valid?
        ...
        render status: 200, json: {headers: redirect_headers, uid: @resource.email}
      else
        render status: 404, json: {headers: nil}
      end
    end
    ...
    def update
      ...
      if @resource.send(resource_update_method, password: params[:password],
